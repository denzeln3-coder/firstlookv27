      ...
      <div className="fixed top-0 left-0 right-0 bg-[#000000]/95 backdrop-blur-lg z-20 border-b border-[rgba(255,255,255,0.06)]">
        <div className="px-4 py-3 flex items-center justify-between">
          ...
          <div className="flex items-center gap-2">
            <button onClick={() => setShowSearch(!showSearch)} className="p-2 rounded-full bg-[rgba(255,255,255,0.06)] text-[#8E8E93] hover:text-white transition-all duration-200">
              <Search className="w-4 h-4" />
            </button>

            <button onClick={() => setShowFilters(!showFilters)} className="p-2 rounded-full bg-[rgba(255,255,255,0.06)] text-[#8E8E93] hover:text-white transition-all duration-200">
            ...
            {user && (
              <button onClick={() => navigate(createPageUrl('Messages'))} className="relative p-2 rounded-full bg-[rgba(255,255,255,0.06)] text-[#8E8E93] hover:text-white transition-all duration-200">
          ...
          <div className="px-4 py-4 border-t border-[rgba(255,255,255,0.06)] slide-up">
            <div className="space-y-4">
              ...
              {(selectedCategory !== 'all' || selectedStage !== 'all') && (
                <button onClick={() => { setSelectedCategory('all'); setSelectedStage('all'); }} className="text-[#8B5CF6] hover:text-[#9D6FFF] text-[12px] font-semibold transition-all duration-200">
                  Clear filters
                </button>
              )}
            </div>
            ...
            <div className="text-center px-6">
              ...
              <div className="flex flex-col gap-3">
                <button
                  ...
                  className="px-6 py-3 bg-gradient-to-r from-[#6366F1] to-[#8B5CF6] text-white font-semibold rounded-xl hover:brightness-110 transition-all duration-200"
                >
                  Record your pitch
                </button>
                <button
                  onClick={() => { setSearchInput(""); setShowSearch(false); setSelectedCategory("all"); setSelectedStage("all"); setSortBy("trending"); }}
                  className="px-6 py-2.5 text-[#A1A1AA] font-medium hover:text-white transition-all duration-200"
                >
                  Clear filters
                </button>
              </div>
